...
#+begin_src emacs-lisp
  ...
  OFFSET can be provided to skip a given number of buffers."
    ...
    (defun my-update-dynamic-persps ()
      ...
      (let* ((current-persps (remove "none" persp-names-cache))
             (ordered-existing
             ...
             (new-persps
              (seq-remove (lambda (name) (member name ordered-existing))
                          current-persps)))
        (setq my-dynamic-persps (append ordered-existing new-persps))))
    ...
    (defun my/apply-persp-order ()
      ...
      (let* ((current-persps (remove "none" persp-names-cache))
        ...
        (cond
         ...
         (t
          (setq my-dynamic-persps new-order)
    ...
    (global-set-key (kbd "C-x p r") 'my/edit-persp-order)
