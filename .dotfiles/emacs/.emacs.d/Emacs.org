...
#+begin_src emacs-lisp
  (use-package persp-mode
    ...
    (dolist (module '("ox-workspace" "ox-terminal" "ox-buffer-navigation"))
...
(defun ox/evil-ghostel-enter-terminal-state ()
  "Start a Ghostel buffer in evil-ghostel's terminal state."
  (evil-ghostel-toggle-send-escape 'terminal))

(use-package evil-ghostel
  :straight t
  :after (ghostel evil)
  :hook ((ghostel-mode . evil-ghostel-mode)
         (ghostel-mode . ox/evil-ghostel-enter-terminal-state))
  :config
  (evil-define-key '(visual insert normal)
